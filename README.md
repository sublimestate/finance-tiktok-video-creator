...
- **OCI Object Storage** — HD video upload/download (bucket: YOUR_BUCKET, namespace: YOUR_NAMESPACE)
...
- OCI Object Storage: bucket `YOUR_BUCKET`, namespace `YOUR_NAMESPACE`, region `us-ashburn-1`
...
obj = client.get_object('YOUR_NAMESPACE', 'YOUR_BUCKET', 'VIDEO_ID.mp4')
